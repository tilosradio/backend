...
public class ModelTest {
    ...
    public void testContent() throws Exception {
        ...
        ClassResolver resolver = new ClassResolver() {
            ...
            public Class<?> resolveElementName(String ns, String location) throws Exception {
    ...
    public void testIt() throws Exception {
        ...
        e.getAnyOther().add(new Duration(720));
        e.getAnyOther().add(new net.anzix.jaxrs.atom.itunes.Summary("asd"));
        feed.getEntries().add(e);

        feed.addAnyOther(new Owner("valaki", "lajos@ignore.xxx"));
        feed.addAnyOther(new Category("Music"));

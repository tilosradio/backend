...
public class ScheduledEpisodeProviderTest {
  ...
  public void testListEpisode() throws Exception {
    ...
    loadTo(mongodb, "show", "show-3utas.json");

    //when
    List<EpisodeData> episodes =
        p.listEpisode("1", SDF.parse("2014-04-03 12:00:00"),
  ...
  public void testListEpisodeWithBase() throws Exception {
    //given
    p.setDb(mongodb);
    loadTo(mongodb, "show", "show-vendeglo.json");

    //when
    List<EpisodeData> episodes =
        p.listEpisode("3", SDF.parse("2014-04-03 12:00:00"),
            SDF.parse("2014-05-03 12:00:00"));
